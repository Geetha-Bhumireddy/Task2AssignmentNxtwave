  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover expert doctors for in-clinic sessions near you. Choose by specialisation, gender, fees, and languages. Book a consultation with top healthcare professionals today."
        />
      </Helmet>

      {/* main content section */}
      <div className="w-full bg-white-A700 pb-[303px] md:pb-5 slide-in">
        {/* header section */}
          ...
          <div className="mx-auto mt-[53px] flex w-full max-w-[1148px] gap-10 md:flex-col md:p-5">
            {[...Array(3)].map((d, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-[9px] slide-in">
                  ...
                  <Button className="pulse flex h-[53px] w-full items-center justify-center rounded-lg bg-green-800 px-[35px] text-center text-base font-semibold tracking-[-0.16px] text-white-A700 sm:px-5">
                    Book a consultation
                  </Button>
                </div>
              </div>
